...
part 'string_validation/components/address_validation.dart';
part 'string_validation/components/password_validation.dart';
part 'string_validation/components/search_job_validation.dart';
...
part 'string_validation/components/custom_service_name.dart';
...
abstract class Validation<T> extends BaseValidation<T> {
  const Validation({ValidationStrings? strings}) : super(strings: strings);
