...
extension SilverCustomizationsExtension on TextStyle {
  ...
  /// FontSize: 20
  TextStyle get sLarger => sized(20);

  /// FontSize: 22
  TextStyle get sExtraLarge => sized(22);

  /// FontSize: 24
  TextStyle get sExtraLarger => sized(24);

  /// FontSize: 28
  TextStyle get sExtraLargerHeader1 => sized(28);
  ...
  /// FontWeight: w800
  TextStyle get wSemiBlock => weighted(FontWeight.w800);
  ...
  //----------------------------------------------------------------------------
  /// FontColor: Red
  TextStyle get cRed => colored(AppColors.errorTextFieldColor);
